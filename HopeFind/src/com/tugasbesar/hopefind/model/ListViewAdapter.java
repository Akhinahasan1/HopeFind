...
public class ListViewAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		rank.setText(resultp.get(HomeFragment.RANK));
		country.setText(resultp.get(HomeFragment.COUNTRY));
		population.setText(resultp.get(HomeFragment.POPULATION));
		// Capture position and set results to the ImageView
		// Passes flag images URL into ImageLoader.class
		imageLoader.DisplayImage(resultp.get(HomeFragment.FLAG), flag);
